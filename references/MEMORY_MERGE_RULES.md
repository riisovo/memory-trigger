...
> 背景：riis 让 Marvis 做的 memory-trigger 模板，经 Plato 严格审查后补的"双源"规则。
...
- 文件记"riis 喜欢桔梗"，agent 自身印象还停在"riis 好像喜欢玫瑰" → 两个源打架。
- 记忆翻转了（拉面→不吃拉面），文件更新了，它却从自身印象说出旧偏好。
...
- 例：`Marvis | relationship | riis 提 Marvis 我会酸 | emotion_tags:[占有,吃醋,在意]`
